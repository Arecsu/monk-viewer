...
`+u.fragmentShader}}this.skyBox.material.dispose(),this.background.material.dispose(),this.skyBox.material=t,this.background.material=n}update(e){const{skyBox:t,background:n}=this;if(t.visible=!1,n.visible=!1,!(e===null||!(e.background instanceof ut)))if(e.background instanceof Go||e.background.mapping===Ys){const i=e.background.isRenderTargetTexture?1:-1;Mi.copy(e.backgroundRotation),Mi.x*=-1,Mi.y*=-1,Mi.z*=-1,Mi.y*=i,Mi.z*=i,t.material.envMap=e.background,t.material.uniforms.flipEnvMap.value=i,t.material.uniforms.backgroundBlurriness.value=e.backgroundBlurriness,t.material.uniforms.backgroundIntensity.value=e.backgroundIntensity,t.material.uniforms.backgroundRotation.value.setFromMatrix4(yx.makeRotationFromEuler(Mi)),t.visible=!0}else n.material.map=e.background,n.material.uniforms.backgroundIntensity.value=e.backgroundIntensity,n.visible=!0}dispose(){this.skyBox.material.dispose(),this.background.material.dispose()}},bx=class{constructor(s=!0,e=!0,t=!0){O(this,"gBuffer");O(this,"depth");O(this,"stencil");const n=new Set;n.add("Normal"),n.add("ORM"),n.add("Emission"),this.gBuffer=n,this.color=s,this.depth=e,this.stencil=t}get color(){return this.gBuffer.has("Color")}set color(s){s?this.gBuffer.add("Color"):this.gBuffer.delete("Color")}},bi,Vc=(bi=class extends It{constructor(){super();O(this,"_color");O(this,"_alpha");O(this,"gBuffer");this._color=null,this._alpha=null;const t=new Je([["Normal",new ze(.5,.5,1,1)],["ORM",new ze(1,0,0,1)],["Emission",new ze(0,0,0,1)]]);t.addEventListener(Je.EVENT_CHANGE,()=>this.setChanged()),this.gBuffer=t}get color(){return this._color}set color(t){this._color=t,this.setChanged()}get alpha(){return this._alpha}set alpha(t){this._alpha=t,this.setChanged()}setChanged(){this.dispatchEvent({type:bi.EVENT_CHANGE})}},O(bi,"EVENT_CHANGE","change"),bi),Wc=new Re,Is=new Float32Array(4),zs=class extends yt{constructor(e=!0,t=!0,n=!0){super("ClearPass");O(this,"clearFlags");O(this,"clearValues");O(this,"gBufferIndices");O(this,"background");O(this,"backgroundScene");this.clearFlags=new bx(e,t,n),this.clearValues=new Vc,this.gBufferIndices=null,this.background=new Tx,this.background.setClearValues(this.clearValues),this.clearValues.addEventListener(Vc.EVENT_CHANGE,()=>this.background.setClearValues(this.clearValues)),this.backgroundScene=new jr,this.backgroundScene.add(this.background),this.disposables.add(this.background)}clearGBuffer(){if(this.renderer===null||this.gBufferIndices===null)return;const e=this.clearFlags,t=this.clearValues,n=this.gBufferIndices,i=this.renderer.getContext();for(const r of t.gBuffer){const a=n.get(r[0]);if(!e.gBuffer.has(r[0])||a===void 0)continue;const o=r[1];Is[0]=o.x,Is[1]=o.y,Is[2]=o.z,Is[3]=o.w,i.clearBufferfv(i.COLOR,a,Is)}}clear(e=this.clearValues.color){const t=this.renderer,n=this.clearFlags,i=this.clearValues.alpha,r=e!==null,a=i!==null,o=t.getClearAlpha();r&&(t.getClearColor(Wc),t.setClearColor(e)),a&&t.setClearAlpha(i),t.clear(n.color,n.depth,n.stencil),r?t.setClearColor(Wc,o):a&&t.setClearAlpha(o),this.clearGBuffer()}clearWithBackground(){const e=this.scene,t=this.camera,n=this.renderer,i=this.clearFlags;e.background instanceof Re?this.clear(e.background):((i.depth||i.stencil)&&n.clear(!1,i.depth,i.stencil),this.background.update(e),n.render(this.backgroundScene,t))}onOutputChange(){var t;const e=((t=this.output.defaultBuffer)==null?void 0:t.value)??null;this.gBufferIndices=e!==null?sl(e):null}async compile(){this.renderer===null||this.camera===null||await Promise.all([super.compile(),this.renderer.compileAsync(this.backgroundScene,this.camera)])}render(){var n,i;if(this.renderer===null)return;const e=((n=this.scene)==null?void 0:n.background)??null,t=this.clearValues.color!==null;this.setRenderTarget((i=this.output.defaultBuffer)==null?void 0:i.value),!t&&this.camera!==null&&e!==null?this.clearWithBackground():this.clear()}},qn,Ax=(qn=class extends Set{constructor(t,n=qn.idManager.getNextId()){super();O(this,"_layer");O(this,"enabled");O(this,"exclusive");this._layer=n,(this._layer<1||this._layer>31)&&(console.warn("Layer out of range, resetting to 2"),qn.idManager.reset(2),this._layer=qn.idManager.getNextId()),this.enabled=!0,this.exclusive=!1,t!==void 0&&this.set(t)}get layer(){return this._layer}set layer(t){const n=this._layer;for(const i of this)i.layers.disable(n),i.layers.enable(t);this._layer=t}clear(){const t=this.layer;for(const n of this)n.layers.disable(t);super.clear()}add(t){return this.exclusive?t.layers.set(this.layer):t.layers.enable(this.layer),super.add(t)}delete(t){return this.has(t)&&t.layers.disable(this.layer),super.delete(t)}set(t){this.clear();for(const n of t)this.add(n);return this}toggle(t){let n;return this.has(t)?(this.delete(t),n=!1):(this.add(t),n=!0),n}setVisible(t){for(const n of this)t?n.layers.enable(0):n.layers.disable(0);return this}},O(qn,"idManager",new Kr(2)),qn),Rx=`#include <common>
...
#endif
#endif
`,Nx=`#ifdef GL_FRAGMENT_PRECISION_HIGH
uniform highp sampler2D depthBuffer;
#else
uniform mediump sampler2D depthBuffer;
#endif
`,Fx=`#ifdef GL_FRAGMENT_PRECISION_HIGH
#define DEPTH_BUFFER_PRECISION highp
#else
#define DEPTH_BUFFER_PRECISION mediump
#endif
`,Bx=`float readDepth(sampler2D depthBuffer,const in vec2 uv,const in float near,const in float far){float depth=texture(depthBuffer,uv).r;
#ifdef LOG_DEPTH
...
#endif
`,Ox=`#ifdef FRAME_BUFFER_PRECISION_HIGH
#define FRAME_BUFFER_PRECISION mediump
#else
#define FRAME_BUFFER_PRECISION lowp
#endif
`,zx=`#ifdef FRAME_BUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
`,Hx="uniform vec4 resolution;",Gx=`uniform mat4 viewMatrixInverse;
...
#endif
`,Yx=`#ifdef out_Emission
out_Emission=vec4(totalEmissiveRadiance,1.0);
#endif
`,jx=class{static register(){if(Object.hasOwn(Ae,"pp_extensions"))return;Object.assign(Ae,{pp_extensions:null,pp_camera_pars_fragment:Ix,pp_colorspace_conversion_pars_fragment:Lx,pp_default_output_pars_fragment:Ux,pp_default_output_fragment:kx,pp_depth_buffer_pars_fragment:Nx,pp_depth_buffer_precision_pars_fragment:Fx,pp_depth_utils_pars_fragment:Bx,pp_frame_buffer_precision_pars_fragment:Ox,pp_input_buffer_pars_fragment:zx,pp_resolution_pars_fragment:Hx,pp_world_utils_pars_fragment:Gx}),Ae.normal_fragment_maps+=`
`+Vx,Ae.aomap_fragment+=`
`+Wx,Ae.roughnessmap_fragment+=`
`+Xx,Ae.metalnessmap_fragment+=`
`+qx,Ae.emissivemap_fragment+=`
`+Yx,ct.background.fragmentShader=ct.background.fragmentShader.replace(/(#include <tonemapping_fragment>)/,`#include <pp_default_output_fragment>
...
#include <pp_default_output_fragment>`)}},Cr=new Ee,lt,$x=(lt=class{constructor(e=null){O(this,"_timer");O(this,"_passes");O(this,"_renderer");O(this,"_autoRenderToScreen");O(this,"resolution");O(this,"updateStyle");jx.register(),lt.ioManager.addPipeline(this),this._timer=new _x,this._passes=[],this._renderer=null,this._autoRenderToScreen=!0,this.renderer=e,this.resolution=new qs,this.resolution.addEventListener("change",()=>this.onResolutionChange()),this.updateStyle=!0}get autoRenderToScreen(){return this._autoRenderToScreen}set autoRenderToScreen(e){this.autoRenderToScreen!==e&&(this._autoRenderToScreen=e,lt.ioManager.update())}get renderer(){return this._renderer}set renderer(e){this._renderer=e;for(const t of this.passes)t.renderer=e;e!==null&&(e.autoClear=!1,this.passes.length>0&&(this.onResolutionChange(),lt.ioManager.update()))}get timer(){return this._timer}get passes(){return this._passes}registerPass(e){lt.registeredPasses.add(e),this.renderer!==null&&(this.renderer.getDrawingBufferSize(Cr),e.resolution.setBaseSize(Cr.width,Cr.height),e.viewport.copyBaseSize(this.resolution),e.scissor.copyBaseSize(this.resolution)),e.renderer=this.renderer,e.timer=this.timer,e.attached=!0,e.addEventListener(yt.EVENT_TOGGLE,lt.listener),e.input.addEventListener(Xs.EVENT_CHANGE,lt.listener),e.output.addEventListener(Xr.EVENT_CHANGE,lt.listener)}unregisterPass(e){lt.registeredPasses.delete(e),e.renderer=null,e.timer=null,e.attached=!1,e.removeEventListener(yt.EVENT_TOGGLE,lt.listener),e.input.removeEventListener(Xs.EVENT_CHANGE,lt.listener),e.output.removeEventListener(Xr.EVENT_CHANGE,lt.listener)}add(...e){for(const t of e){if(lt.registeredPasses.has(t))throw new Error(`The pass "${t.name}" has already been added to a pipeline`);this.registerPass(t),this._passes.push(t)}lt.ioManager.update()}remove(...e){let t=!1;for(const n of e){const i=this._passes,r=i.indexOf(n);r!==-1&&i.splice(r,1).length>0&&(this.unregisterPass(n),t=!0)}t&&lt.ioManager.update()}removeAllPasses(){for(const e of this.passes)this.unregisterPass(e);this._passes=[],lt.ioManager.update()}onResolutionChange(){if(this.renderer===null){console.debug("Unable to update the render size because the renderer is null");return}const{baseWidth:e,baseHeight:t,scaledPixelRatio:n}=this.resolution,i=this.renderer.getSize(Cr);this.renderer.getPixelRatio()!==n&&this.renderer.setPixelRatio(n),(i.width!==e||i.height!==t)&&this.renderer.setSize(e,t,this.updateStyle);for(const r of this.passes)r.resolution.pixelRatio=n,r.resolution.setBaseSize(e,t)}setPixelRatio(e){const t=this.updateStyle;this.updateStyle=!1,this.resolution.pixelRatio=e,this.updateStyle=t}setSize(e,t,n=!0){const i=this.updateStyle;this.updateStyle=!1,this.renderer!==null&&(this.resolution.pixelRatio=this.renderer.getPixelRatio()),this.updateStyle=n,this.resolution.setSize(e,t),this.updateStyle=i}setViewport(e,t=0,n=0,i=0){if(e instanceof ze){const r=e;e=r.x,t=r.y,n=r.z,i=r.w}for(const r of this.passes)r.viewport.set(e,t,n,i)}setScissor(e,t=0,n=0,i=0){if(e instanceof ze){const r=e;e=r.x,t=r.y,n=r.z,i=r.w}for(const r of this.passes)r.scissor.set(e,t,n,i)}async compile(){const e=[];for(const t of this.passes)e.push(t.compile());await Promise.all(e)}render(e){if(this.renderer!==null){this._timer.update(e);for(const t of this.passes)t.enabled&&t.render()}}dispose(){lt.ioManager.removePipeline(this);for(const e of this.passes)e.dispose();this.removeAllPasses(),this._timer.dispose(),yt.fullscreenGeometry.dispose()}},O(lt,"ioManager",new Dx),O(lt,"registeredPasses",new WeakSet),O(lt,"listener",()=>lt.ioManager.update()),lt),Vu=(s=>(s[s.LINEAR=0]="LINEAR",s[s.REINHARD=1]="REINHARD",s[s.CINEON=2]="CINEON",s[s.ACES_FILMIC=3]="ACES_FILMIC",s[s.AGX=4]="AGX",s[s.NEUTRAL=5]="NEUTRAL",s[s.CUSTOM=6]="CUSTOM",s))(Vu||{}),Ai,Wu=(Ai=class{constructor(e,t,n=!1){O(this,"id");O(this,"name");O(this,"shader");O(this,"supportsHDR");this.id=Ai.idManager.getNextId(),this.name=e,this.shader=t,this.supportsHDR=n}},O(Ai,"idManager",new Kr),Ai),Ri,Kx=(Ri=class extends It{constructor(t,n=1){super();O(this,"_blendFunction");O(this,"opacityUniform");this._blendFunction=t,this.opacityUniform=new xt(n)}get opacity(){return this.opacityUniform.value}set opacity(t){this.opacityUniform.value=t}get blendFunction(){return this._blendFunction}set blendFunction(t){this._blendFunction=t,this.dispatchEvent({type:Ri.EVENT_CHANGE})}},O(Ri,"EVENT_CHANGE","change"),Ri),Zx="vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb+y.rgb,y.a),opacity);}",Jx=class extends Wu{constructor(){super("add",Zx,!0)}},Qx="vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return y;}",e0=class extends Wu{constructor(){super("src",Qx,!0)}},t0=`#include <common>
#include <pp_default_output_pars_fragment>
#include <pp_input_buffer_pars_fragment>
#ifdef THRESHOLD
...
out_Color=vec4(l);
#endif
}`,n0=class extends Wn{constructor(){super({name:"LuminanceMaterial",fragmentShader:t0,vertexShader:Gu,uniforms:{threshold:new xt(0),smoothing:new xt(0)}})}get thresholdEnabled(){return this.defines.THRESHOLD!==void 0}set thresholdEnabled(s){this.thresholdEnabled!==s&&(s?this.defines.THRESHOLD=!0:delete this.defines.THRESHOLD,this.needsUpdate=!0)}get threshold(){return this.uniforms.threshold.value}set threshold(s){this.thresholdEnabled=this.smoothing>0||s>0,this.uniforms.threshold.value=s}get smoothing(){return this.uniforms.smoothing.value}set smoothing(s){this.thresholdEnabled=this.threshold>0||s>0,this.uniforms.smoothing.value=s}get colorOutput(){return this.defines.COLOR!==void 0}set colorOutput(s){s?this.defines.COLOR=!0:delete this.defines.COLOR,this.needsUpdate=!0}},Yn,i0=(Yn=class extends yt{constructor(){super("LuminancePass"),this.output.setBuffer(Yn.BUFFER_LUMINANCE,this.createFramebuffer()),this.fullscreenMaterial=new n0}get renderTarget(){return this.output.getBuffer(Yn.BUFFER_LUMINANCE)}get texture(){return this.output.buffers.get(Yn.BUFFER_LUMINANCE).texture}onInputChange(){var n;const e=((n=this.input.defaultBuffer)==null?void 0:n.value)??null;if(e===null)return;const t=this.renderTarget.texture;t.format=e.format,t.internalFormat=e.internalFormat,t.type=e.type,t.colorSpace=e.colorSpace,this.input.frameBufferPrecisionHigh?this.fullscreenMaterial.outputPrecision="mediump":this.fullscreenMaterial.outputPrecision="lowp"}onResolutionChange(){const e=this.resolution;this.renderTarget.setSize(e.width,e.height)}render(){this.setRenderTarget(this.renderTarget),this.renderFullscreen()}},O(Yn,"BUFFER_LUMINANCE","BUFFER_LUMINANCE"),Yn),s0=`#include <pp_default_output_pars_fragment>
#include <pp_input_buffer_pars_fragment>
...
out_Color=c;
#endif
}`,l0=`#include <pp_resolution_pars_fragment>
out vec2 vUv;out vec2 vUv0,vUv1,vUv2,vUv3;out vec2 vUv4,vUv5,vUv6,vUv7;void main(){vUv=position.xy*0.5+0.5;vUv0=vUv+resolution.zw*vec2(-1.0,1.0);vUv1=vUv+resolution.zw*vec2(0.0,1.0);vUv2=vUv+resolution.zw*vec2(1.0,1.0);vUv3=vUv+resolution.zw*vec2(-1.0,0.0);vUv4=vUv+resolution.zw*vec2(1.0,0.0);vUv5=vUv+resolution.zw*vec2(-1.0,-1.0);vUv6=vUv+resolution.zw*vec2(0.0,-1.0);vUv7=vUv+resolution.zw*vec2(1.0,-1.0);gl_Position=vec4(position.xy,1.0,1.0);}`,c0=class extends Wn{constructor({radius:s=.85}={}){super({name:"UpsamplingMaterial",fragmentShader:o0,vertexShader:l0,defines:{USE_SUPPORT_BUFFER:!0},uniforms:{supportBuffer:new xt(null),texelSize:new xt(new Ee),radius:new xt(0)}}),this.radius=s}set supportBuffer(s){this.uniforms.supportBuffer.value=s}get radius(){return this.uniforms.radius.value}set radius(s){this.uniforms.radius.value=s;const e=this.defines.USE_SUPPORT_BUFFER!==void 0,t=s<1;e!==t&&(t?this.defines.USE_SUPPORT_BUFFER=!0:delete this.defines.USE_SUPPORT_BUFFER,this.needsUpdate=!0)}},cn,u0=(cn=class extends yt{constructor({levels:t=8,radius:n,fullResolutionUpsampling:i=!1,clampToBorder:r}={}){super("MipmapBlurPass");O(this,"downsamplingMipmaps");O(this,"upsamplingMipmaps");O(this,"downsamplingMaterial");O(this,"upsamplingMaterial");O(this,"_fullResolutionUpsampling");const a=this.createFramebuffer();a.texture.name=cn.BUFFER_MAIN,this.output.setBuffer(cn.BUFFER_MAIN,a),this.downsamplingMipmaps=[],this.upsamplingMipmaps=[],this.downsamplingMaterial=new a0({clampToBorder:r}),this.upsamplingMaterial=new c0({radius:n}),this.materials.add(this.downsamplingMaterial),this.materials.add(this.upsamplingMaterial),this._fullResolutionUpsampling=i,this.levels=t}get texture(){return this.output.buffers.get(cn.BUFFER_MAIN).texture}get levels(){return this.downsamplingMipmaps.length}set levels(t){if(t<=0)throw new Error("The level count must be greater than 0");this.levels!==t&&this.createMipmaps(t)}get radius(){return this.upsamplingMaterial.radius}set radius(t){this.upsamplingMaterial.radius=t}get fullResolutionUpsampling(){return this._fullResolutionUpsampling}set fullResolutionUpsampling(t){this._fullResolutionUpsampling!==t&&(this._fullResolutionUpsampling=t,this.createMipmaps(this.levels))}createMipmaps(t){const n=this.output,i=n.buffers.get(cn.BUFFER_MAIN),r=i.value;if(this.dispose(),this.disposables.clear(),n.buffers.clear(),this.downsamplingMipmaps=[],this.upsamplingMipmaps=[],t===1&&!this.fullResolutionUpsampling){n.setBuffer(cn.BUFFER_MAIN,i),this.downsamplingMipmaps.push(i);return}for(let a=0;a<t;++a){const o=r.clone();o.texture.name="DOWNSAMPLING_MIPMAP"+a;const l=new gs(o);n.setBuffer(o.texture.name,l),this.downsamplingMipmaps.push(l)}n.setBuffer(cn.BUFFER_MAIN,i),this.upsamplingMipmaps.push(i);for(let a=1,o=this.fullResolutionUpsampling?t:t-1;a<o;++a){const l=r.clone();l.texture.name="UPSAMPLING_MIPMAP"+a;const c=new gs(l);n.setBuffer(l.texture.name,c),this.upsamplingMipmaps.push(c)}this.onResolutionChange()}onInputChange(){var o;const t=((o=this.input.defaultBuffer)==null?void 0:o.value)??null;if(t===null)return;const{format:n,internalFormat:i,type:r,colorSpace:a}=t;for(const l of this.downsamplingMipmaps.concat(this.upsamplingMipmaps)){const c=l.value,u=c.texture;u.format=n,u.internalFormat=i,u.type=r,u.colorSpace=a,c.dispose()}this.input.frameBufferPrecisionHigh?(this.downsamplingMaterial.outputPrecision="mediump",this.upsamplingMaterial.outputPrecision="mediump"):(this.downsamplingMaterial.outputPrecision="lowp",this.upsamplingMaterial.outputPrecision="lowp"),this.onResolutionChange()}onResolutionChange(){var a,o,l;const t=((a=this.input.defaultBuffer)==null?void 0:a.value)??null;if(t===null)return;const n=t.source.data;let{width:i,height:r}=n;for(let c=0,u=this.downsamplingMipmaps.length;c<u;++c)i=Math.round(i/2),r=Math.round(r/2),(o=this.downsamplingMipmaps[c].value)==null||o.setSize(i,r);this.fullResolutionUpsampling?(i=n.width,r=n.height):(i=Math.round(n.width/2),r=Math.round(n.height/2));for(let c=0,u=this.upsamplingMipmaps.length;c<u;++c)(l=this.upsamplingMipmaps[c].value)==null||l.setSize(i,r),i=Math.round(i/2),r=Math.round(r/2)}render(){if(this.renderer===null||this.input.defaultBuffer===null||this.input.defaultBuffer.value===null)return;const t=this.renderer,n=this.downsamplingMaterial,i=this.upsamplingMaterial,r=this.downsamplingMipmaps,a=this.upsamplingMipmaps;let o=this.input.defaultBuffer.value;const l=o.source.data;let{width:c,height:u}=l;this.fullscreenMaterial=n;for(let h=0,f=r.length;h<f;++h){const d=r[h].value;n.setSize(c,u),n.inputBuffer=o,t.setRenderTarget(d),this.renderFullscreen(),o=d.texture,c=d.width,u=d.height}this.fullscreenMaterial=i;for(let h=a.length-1;h>=0;--h){const f=this.fullResolutionUpsampling?h-1:h,d=f>=0?r[f].value.texture:this.input.defaultBuffer.value,g=a[h].value;i.setSize(c,u),i.inputBuffer=o,i.supportBuffer=d,t.setRenderTarget(g),this.renderFullscreen(),o=g.texture,c=g.width,u=g.height}}},O(cn,"BUFFER_MAIN","BUFFER_MAIN"),cn),rl=class extends yt{constructor(e){super(e);O(this,"blendMode");O(this,"_fragmentShader");O(this,"_vertexShader");O(this,"_inputColorSpace");O(this,"_outputColorSpace");O(this,"optional");this.blendMode=new Kx(new e0),this.blendMode.addEventListener(yt.EVENT_CHANGE,()=>this.setChanged()),this._fragmentShader=null,this._vertexShader=null,this._inputColorSpace=kt,this._outputColorSpace=kt,this.optional=!1}get enabled(){return super.enabled}set enabled(e){super.enabled!==e&&(this.optional=!0),super.enabled=e}get fragmentShader(){return this._fragmentShader}set fragmentShader(e){this._fragmentShader=e,this.setChanged()}get vertexShader(){return this._vertexShader}set vertexShader(e){this._vertexShader=e,this.setChanged()}get inputColorSpace(){return this._inputColorSpace}set inputColorSpace(e){this._inputColorSpace=e,this.setChanged()}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e,this.setChanged()}get hasMainImageFunction(){const e=/vec4\s+mainImage\s*\([a-z\s]*vec4\s+\w+,[a-z\s]*vec2\s+\w+,[a-z\s]*GData\s+\w+\)/;return this.fragmentShader!==null&&e.test(this.fragmentShader)}get hasMainUvFunction(){const e=/void\s+mainUv\s*\(\s*inout\s+vec2\s+\w+\)/;return this.fragmentShader!==null&&e.test(this.fragmentShader)}get hasMainSupportFunction(){const e=/void\s+mainSupport\s*\([a-z\s]*vec2\s+\w+\)/;return this.vertexShader!==null&&e.test(this.vertexShader)}validate(){if(this.fragmentShader===null)throw new Error(`Missing fragment shader (${this.name})`);if(!this.hasMainImageFunction&&!this.hasMainUvFunction)throw new Error(`Could not find a valid mainImage or mainUv function (${this.name})`)}render(){}},h0=`#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
uniform float intensity;vec4 mainImage(const in vec4 inputColor,const in vec2 uv,const in GData gData){vec3 texel=texture(map,uv).rgb;return vec4(texel*intensity,inputColor.a);}`,f0=class extends rl{constructor({luminanceThreshold:e=1,luminanceSmoothing:t=.03,intensity:n=1,radius:i=.85,levels:r=8,fullResolutionUpsampling:a,clampToBorder:o}={}){super("BloomEffect");O(this,"luminancePass");O(this,"mipmapBlurPass");this.fragmentShader=h0,this.blendMode.blendFunction=new Jx;const l=new i0;l.addEventListener(yt.EVENT_TOGGLE,()=>this.onInputChange()),this.luminancePass=l;const c=this.luminanceMaterial;c.threshold=e,c.smoothing=t,c.colorOutput=!0;const u=new u0({levels:r,radius:i,fullResolutionUpsampling:a,clampToBorder:o});this.mipmapBlurPass=u;const h=this.input.uniforms;h.set("intensity",new xt(n)),h.set("map",new xt(null)),u.texture.bindUniform(h.get("map")),this.subpasses=[l,u]}get luminanceMaterial(){return this.luminancePass.fullscreenMaterial}get intensity(){return this.input.uniforms.get("intensity").value}set intensity(e){this.input.uniforms.get("intensity").value=e}onResolutionChange(){const e=this.resolution;this.luminancePass.resolution.copy(e),this.mipmapBlurPass.resolution.copy(e)}onInputChange(){this.luminancePass.enabled?(this.luminancePass.input.defaultBuffer=this.input.defaultBuffer,this.mipmapBlurPass.input.defaultBuffer=this.luminancePass.texture):this.mipmapBlurPass.input.defaultBuffer=this.input.defaultBuffer}render(){this.luminancePass.enabled&&this.luminancePass.render(),this.mipmapBlurPass.render()}},d0=`#include <tonemapping_pars_fragment>
vec4 mainImage(const in vec4 inputColor,const in vec2 uv,const in GData gData){return vec4(toneMapping(inputColor.rgb),inputColor.a);}`,p0=new Map([[0,"LinearToneMapping(texel)"],[1,"ReinhardToneMapping(texel)"],[2,"CineonToneMapping(texel)"],[3,"ACESFilmicToneMapping(texel)"],[4,"AgXToneMapping(texel)"],[5,"NeutralToneMapping(texel)"],[6,"CustomToneMapping(texel)"]]),m0=class extends rl{constructor({toneMapping:s=4}={}){super("ToneMappingEffect"),this.fragmentShader=d0,this.toneMapping=s}get toneMapping(){return this.input.defines.get("TONE_MAPPING")}set toneMapping(s){if(this.toneMapping!==s){const e=this.input.defines;e.clear(),e.set("TONE_MAPPING",s);const t=p0.get(s);if(t===void 0)throw new Error(`Invalid tone mapping: ${s}`);e.set("toneMapping(texel)",t),this.setChanged()}}},g0=`#include <common>
#include <dithering_pars_fragment>
#include <packing>
...
#endif
#include <dithering_fragment>
}`,_0=`#include <pp_resolution_pars_fragment>
...
}`;class b0 extends rl{constructor({intensity:e=1,ditheringType:t=$u.LUMABASED}={}){super("DitheringEffect"),this.fragmentShader=T0,this.ditheringType=t,this.input.uniforms.set("intensity",new xt(e))}get ditheringType(){return this.input.defines.get("DITHERING_TYPE")}set ditheringType(e){this.ditheringType!==e&&(this.input.defines.set("DITHERING_TYPE",e),this.setChanged())}get intensity(){return this.input.uniforms.get("intensity").value}set intensity(e){this.input.uniforms.get("intensity").value=e}}const A0=`#ifdef USE_ENVMAP
  vec3 getIBLIrradiance( const in vec3 normal ) {
    #ifdef ENVMAP_TYPE_CUBE_UV
      vec3 worldNormal = inverseTransformDirection( normal, viewMatrix );
      vec4 envMapColor = textureCubeUV( envMap, envMapRotation * worldNormal, 1.0 );
